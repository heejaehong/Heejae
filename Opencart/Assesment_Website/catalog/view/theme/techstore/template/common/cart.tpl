...
<div id="cart" class="dropdown">
	<?php $get_cart = $theme_options->getCart(); ?>
	<div data-hover="dropdown" data-toggle="dropdown">
		<span class="fa fa-shopping-cart cart-heading"></span>
	...
	<div class="dropdown-menu" id="cart_content"><div id="cart_content_ajax">
		...
		<div class="checkout">
			<a href="<?php echo $cart; ?>" class="button btn btn-theme-default"><?php echo $text_cart; ?></a> 
			<a href="<?php echo $checkout; ?>" class="button btn btn-theme-default"><?php echo $text_checkout; ?></a>
		</div>
		<?php } else { ?>
