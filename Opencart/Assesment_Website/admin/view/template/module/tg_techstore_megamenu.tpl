...
<div id="content"><div class="container-fluid">
	...
	<?php } ?>
	<div class="set-size" id="tg_techstore_megamenu">
					...
					<div class="background clearfix">
						...
						<div class="right">
							...
							<div id="content_type0"<?php if($content_type != '0') { ?> style="display:none"<?php } ?> class="content_type">
								...
								<div id="content_html_<?php echo $language['language_id']; ?>">
...
$(document).ready(function() {
	...
	function menu_updatesort(jsonstring) {
		...
		if (mittXHRobjekt) {
			...
			ajaxRequest.open("GET", "index.php?route=module/tg_techstore_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + jsonstring, true);
