...
<div class="filter-product hidden-xs">
	<div class="box-heading2"><?php echo $heading; ?></div>
	<div class="col-sm-1" style="padding-left: 0px; padding-right: 0px;">
		<div class="filter-tabs">
			<div class="bg-filter-tabs"><div class="bg-filter-tabs2 clearfix">
			<ul id="tab<?php echo $id; ?>" class="tg-filter">
				<?php $i = 0; foreach($tabs as $tab) {
					echo '<li'.($i == 0 ? ' class="active"' : '').'><a href="#'.$tab['title'].'-'.$id.'-'.$i.'"><img src="image/' .$tab['icon']. '"></a></li>';		
				$i++; } ?>
			</ul>
			</div></div>
		</div>
	...
	<div class="col-sm-11" style="padding-left: 0px; padding-right: 0px;">
		<div class="tab-content">
			...
			<div class="tab-pane <?php if($s == 0) { echo 'active'; } ?>" id="<?php echo $tab['title'].'-'.$id.'-'.$s; ?>">
				...
				<div class="box-product tg-filter-holder">
						...
						<div class="carousel-inner">
							<?php $i = 0; $row_fluid = 0; foreach ($tab['products'] as $product) { $row_fluid++; ?>
								...
								<div class="col-sm-<?php echo $class; ?> col-xs-6">
									<?php include('catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/template/themeglobal/product2.tpl'); ?>
								</div>
							<?php $i++; } ?>
