...
//                BrainyFilter.sendRequest();
    ...
    //        var searchFilters = {};
        ...
        shrinkBlock: function(block, items, disableAnim) {
            ...
            if (!items) {
                jQuery(block).closest('.bf-attr-block').find('.fa-angle-down').removeClass('fa-angle-down');
				jQuery(block).closest('.bf-attr-block').find('.fa').addClass('fa-angle-right');
            }
        ...
        expandBlock: function(block, disableAnim) {
            ...
            wrapper.addClass('bf-expanded');
            jQuery(block).parents('.bf-attr-block').find('fa-angle-right').removeClass('fa-angle-right');
			jQuery(block).parents('.bf-attr-block').find('.fa').addClass('fa-angle-down');
        ...
        collapse: function() {
            ...
            jQuery('.bf-collapse').parents('.bf-attr-block').find('fa-angle-right').removeClass('fa-angle-right');
			jQuery('.bf-collapse').parents('.bf-attr-block').find('.fa').addClass('fa-angle-down');
