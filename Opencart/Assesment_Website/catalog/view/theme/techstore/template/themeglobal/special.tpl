...
<!-- Product -->
<div class="product clearfix" style="border: none;padding-bottom: 0px;">
	<div class="left">
	...
	<div class="right">
		<div class="name" style="padding-top: 5px;">
			<a href="<?php echo $product['href']; ?>">
				<?php if (strlen(utf8_decode($product['name'])) > 18 ) { ?>
				<?php echo utf8_substr(strip_tags(html_entity_decode($product['name'])), 0, 18).".." ?>
				<?php } else { ?> <?php echo $product['name']; ?>
				<?php } ?>
			</a>
		
		</div>
		<div class="price" style="padding-bottom: 6px;">
