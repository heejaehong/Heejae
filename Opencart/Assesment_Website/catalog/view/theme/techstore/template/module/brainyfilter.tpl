        ...
        <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form 
                ...
                <?php foreach ($filters as $i => $section) : ?>
                    ...
                    <?php if ($section['type'] == 'price') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_price; ?><span class="fa fa-angle-down" style="float: right;font-size: 20px;"></span>
                        </div>
                        <div class="bf-attr-block-cont">
                            <div class="bf-price-container box-content bf-attr-filter" style="margin-bottom: 0px;">
                                <?php if (in_array($sliderType, array(1, 3))) : ?>
                                <div class="bf-cur-symb">
                                    <span class="bf-cur-symb-left"><?php echo $currency_symbol; ?></span>
                                    <input type="text" class="bf-range-min" name="bfp_price_min" value="<?php echo $lowerlimit; ?>" maxlength="<?php echo strlen($upperlimit); ?>" size="4" />
                    ...
                    <?php elseif ($section['type'] == 'search') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_search; ?><span class="fa fa-angle-down" style="float: right;font-size: 20px;"></span>
                        </div>
                        <div class="bf-attr-block-cont">
                    ...
                    <?php elseif ($section['type'] == 'category') : ?>
                        ...
                        <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                            <?php echo $lang_categories; ?><span class="fa fa-angle-down" style="float: right;font-size: 20px;"></span>
                        </div>
                        <div class="bf-attr-block-cont">
                            <?php $groupUID = 'c0'; ?>
                    ...
                    <?php else : ?>
                        ...
                        <?php foreach ($section['array'] as $groupId => $group) : ?>
                            ...
                            <div class="bf-attr-header<?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                                <?php echo $group['name']; ?><span class="fa fa-angle-down" style="float: right;font-size: 20px;"></span>
                            </div>
                            <div class="bf-attr-block-cont">
                ...
                <?php if (!$isHorizontal || $settings['submission']['submit_type'] == 'button') : ?><div class="bf-buttonclear-box"<?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                         <input type="button" value="<?php echo $lang_submit; ?>" class="button" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;" <?php if ($settings['submission']['submit_button_type'] != 'fix' && $settings['submission']['submit_type'] != 'button' )  : ?>style="display:none;" <?php endif; ?> />
